...
const obj = reactive({
  terjemahan: JSON.parse(localStorage.getItem('terjemah') || true)
})

watchEffect(() => {
  localStorage.setItem('terjemah', JSON.stringify(obj.terjemahan))
})
</script>
<template>
    ...
    >
      ...
      <div class="grid mt-6 gap-4">
        ...
        <div class="flex justify-between items-center">
          ...
          <div
            @click="obj.terjemahan = !obj.terjemahan"
            class="bg-gradient-to-br from-green-600 to-green-400 py-2 px-3 rounded-lg"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="22" viewBox="0 0 24 24">
              <path fill="none" d="M0 0h24v24H0z"></path>
              <path
          ...
          <!-- <div
            v-else
            @click="obj.terjemahan = false"
            class="bg-gradient-to-br from-red-600 to-green-400 py-2 px-3 rounded-lg"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="22" viewBox="0 0 24 24">
              <path fill="none" d="M0 0h24v24H0z"></path>
              <path
