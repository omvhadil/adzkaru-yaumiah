...
<template>
  <div x-data="{ open: false }">
    ...
    <div
      x-show="open"
      x-transition
      class="w-full h-[100vh] fixed top-0 left-0 z-20 bg-black bg-opacity-25"
    >
      <div class="w-[70%] h-[100vh] shadow-lg fixed top-0 left-0 z-30 bg-gray-100">
        <div
          x-on:click="open = false"
          class="absolute top-3 right-4 hover:bg-white p-1 rounded-lg cursor-pointer"
        >
