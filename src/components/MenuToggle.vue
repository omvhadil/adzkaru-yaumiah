...
<template>
  <div x-data="{ open: false }">
    ...
    <div
      x-show="open"
      x-transition
      class="w-[80%] h-[100vh] shadow-lg fixed top-0 right-0 z-10 bg-white dark:bg-slate-900 py-8 px-6"
    >
      ...
      <div class="absolute top-4 left-4">
        <h6 class="text-lg font-semibold text-green-800 dark:text-slate-100">Pengaturan</h6>
      </div>
      <div class="grid gap-4 mt-8 text-gray-700 dark:text-slate-100 mb-6">
