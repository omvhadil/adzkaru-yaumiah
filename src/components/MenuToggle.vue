...
<template>
  <div x-data="{ open: false }">
    ...
    <div
      x-show="open"
      x-transition
      class="w-[70%] h-[100vh] shadow-lg fixed top-0 left-0 z-10 bg-slate-100"
    >
      <div class="bg-gradient-to-tr from-blue-700 to-blue-400 w-100 h-[160px]">
        <div x-on:click="open = false" class="absolute top-3 right-4">
      ...
      <div class="grid gap-4 text-dark mb-6 pt-4 px-6">
