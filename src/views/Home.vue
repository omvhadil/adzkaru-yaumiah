...
<template>
  <main class="main w-full h-[100vh] bg-slate-50">
    <!-- begin:header  -->
      ...
      <div class="flex mt-4">
        ...
        <div class="w-[80%] p-0">
          <div class="text-center mt-4">
            <h1 class="font-aref text-green-500 text-[3.5rem]">الْخُلاَصَةُ</h1>
        ...
        <div class="w-[20%] p-0">
          <div
            class="shadow-sm rounded-l-3xl bg-gradient-to-b from-green-500 to-blue-500 py-4 grid justify-center gap-3 ms-auto w-[90%]"
          >
            <!-- Madad -->
            <div @click="router.push('madad')" class="text-center">
              <div>
                <div
                  class="cursor-pointer bg-green-200 p-2 rounded-full flex items-center justify-center mx-auto w-[45px] h-[45px]"
                >
    ...
    <div class="px-4 mt-10">
      <div class="overflow-hidden rounded-md bg-tranparent">
        <h5 class="text-center bg-tranparent text-dark py-2 text-uppercase">Pesan</h5>
        <span class="text-center block p-4 text-lg text-dark">"{{ pesan[1].text }}"</span>
      </div>
    </div>
  </main>
</template>
