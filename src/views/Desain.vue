...
<template>
  <main class="main w-full h-[100vh] bg-slate-200 overflow-hidden">
    <!-- header  -->
    <header class="header px-3 bg-slate-50">
    ...
    <section class="section bg-slate-50 pt-4 pb-8">
      <div class="flex">
        ...
        <div class="w-[20%] p-0">
          <div
            class="shadow-sm rounded-l-3xl bg-gradient-to-b from-green-500 to-yellow-400 py-4 grid justify-center gap-3 ms-auto w-[90%]"
          >
            <!-- Madad -->
